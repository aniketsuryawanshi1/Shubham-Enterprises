"""
Django settings for shubham_enterprises project.
...
ROOT_URLCONF = 'shubham_enterprises.urls'
...
WSGI_APPLICATION = 'shubham_enterprises.wsgi.application'
...
#Configuring email settings hare
